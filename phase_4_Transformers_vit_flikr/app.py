...
def load_models():
    ...
    encoder.load_state_dict(
        torch.load("../../../models_bkp/encoder-Vit-Transformer.pth", map_location=device)
    )
    decoder.load_state_dict(
        torch.load("../../../models_bkp/decoder-VT.pth", map_location=device)
    )
...
@st.cache_resource
def load_vocab():
    return torch.load("../../../models_bkp/vocab-VT.pkl", weights_only=False)
